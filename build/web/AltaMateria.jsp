                    ...
                    <center>
                        ...
                        <form action="Controlador" method="POST">
                            ...
                            <div class="custom-control custom-checkbox mb-3">
                                <input type="checkbox" class="custom-control-input" id="customControlValidation1" name="checkbox" value="Correlativa">
                                <label class="custom-control-label" for="customControlValidation1">Correlativa</label>
                            </div>

                            <div class="form-group">
                                <label>Correlativa:</label>
                                <select class="form-control" name="correlative">
                                    <!--<option selected>Correlativa</option>-->
                            ...
                            <br>
                            <input class="dropdown-item-input" style="width: 80%" type="submit" name="accion" value="SaveSubjects">
                            <br>
                            <br>
                            <input class="dropdown-item-input" style="width: 80%" type="submit" name="accion" value="Regresar">
                        </form>
                    </center>
                </div>
            </section>
