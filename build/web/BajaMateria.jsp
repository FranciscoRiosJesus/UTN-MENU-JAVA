                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <c:forEach var="dato" items="${lista}">
                                    <tr>
                                        <th scope="row">${dato.getId_materia()}</th>
                                        <td>${dato.getNombre()}</td>
                                        <td>
                                            <form action="Controlador" method="POST">
                                                <input type="hidden" name="id" value="${dato.getId_materia()}">
                                                <input class="dropdown-item-input" type="submit" name="accion" value="DeleteMateria">
                                            </form>
                                        </td>
                                    </tr>
                                </c:forEach>
