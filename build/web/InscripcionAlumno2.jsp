                    ...
                    <center>
                        ...
                        <form action="Controlador" method="POST">
                            <div class="form-control">
                                <label>Alumno: ${alu}</label>
                                <input class="form-control" type="hidden" name="alu" value="${alu}" disabled>
                            </div>
                            <br>

                            <div class="form-control">
                                <label>Materia: ${mat}</label>
                                <input class="form-control" type="hidden" name="mat" value="${mat}" disabled>
                            </div>
                            <br>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="profesor">
                                    ...
                                    <c:choose>
                                        <c:when test="${empty listaProfesor}">
                                            <c:forEach var="dato" items="${listaProfesores}">
                                                <option>${dato.getId_profesor()}. ${dato.getNombre_apellido()}</option>
                                            </c:forEach>
                                        </c:when> 
                                        <c:otherwise><p>No hay profesores para la materia</p></c:otherwise>
                                    </c:choose>
                                </select>
                            </div>
                            <br>
                            
                            <input class="dropdown-item-input" style="width: 80%;" type="submit" name="accion" value="RegisterStudent">
                        </form>
                    </center>
                </div>
            </section>
