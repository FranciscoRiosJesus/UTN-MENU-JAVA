                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <c:forEach var="dato" items="${lista}">
                                    <tr>
                                        <th scope="row">${dato.getId_profesor()}</th>
                                        <td>${dato.getNombre_apellido()}</td>
                                        <td>
                                            <form action="Controlador" method="POST">
                                                <input type="hidden" name="id" value="${dato.getId_profesor()}">
                                                <input class="dropdown-item-input" type="submit" name="accion" value="DeleteProfesor">
                                            </form>
                                        </td>
                                    </tr>
                                </c:forEach>
